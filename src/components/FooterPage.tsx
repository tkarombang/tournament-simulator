          ...
          <ol className="list-decimal list-inside space-y-2 text-sm sm:text-xs">
            ...
            <li>
              ...
              <ul className="list-disc list-inside ml-4 mt-1 space-y-1">
                <li>Lihat pertandingan yang tersedia di Stage 1 (2 Pertandingan / stage).</li>
                <li>
                ...
                <li>
                  ...
                  <ul className="list-inside ml-4 mt-1 space-y-1">
                    <li className="flex items-center space-x-3 rtl:space-x-reverse">
                      <svg className="shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" fill="none" viewBox="0 0 16 12">
                  ...
                  <ul className="list-inside ml-4 mt-1 space-y-1">
                    <li className="flex items-center space-x-3 rtl:space-x-reverse">
                      ...
                      <div className="flex items-center">
                        <span>Jika ingin memulai ulang simulasi untuk group tertentu, klik tombol</span>
                        <FontAwesomeIcon icon={faRotate} className="ml-2 p-1 flex items-center justify-center text-base text-white bg-red-500 rounded-full" />
                      </div>
                    </li>
                    <li className="flex items-center space-x-3 rtl:space-x-reverse">
                      <svg className="shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" fill="none" viewBox="0 0 16 12">
        ...
        <div className="md:w-1/3 flex items-center">
          <div className="text-center">
            ...
            <p className="text-end mb-6 font-light text-sm/8">
              Aplikasi ini adalah simulator turnamen sepak bola sederhana yang memungkinkan kamu untuk mensimulasikan pertandingan antar tim dalam group. Kamu bisa mengatur skor pertandingan, melihat hasilnya di tabel klasemen, dan meresedt
              simulasi jika diperlukan. Aplikasi ini mendukung simulasi hingga 3 stage per group.
            </p>
          </div>
        </div>
      </div>

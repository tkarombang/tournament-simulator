...
export default function GroupTabs() {
  ...
  // STATE UNTUK SIMPAN SKOR TIAP PERTANDINGAN
  ...
  const handleSimulate = (team1: string, score1: number, team2: string, score2: number, matchId: string) => {
    // CEK APAKAH PERTANDINGAN INI SUDAH DISIMULASIKAN SEBELUMNYA
    ...
    // TANDAI PERTANDINGAN SEBAGAI SUDAH DISIMULASIKAN
    setSimulatedMatches((prev) => new Set(prev).add(matchId));
  };
  ...
  return (
    <div className="p-4">
      ...
      <div>
        ...
        <SimulationForm teams={groupTeams[activeGroup]} activeGroup={activeGroup} scores={scores} setScores={setScores} simulatedMatches={simulatedMatches} onSimulate={handleSimulate} />
      </div>
    </div>
  );
}
